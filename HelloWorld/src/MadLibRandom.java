...
public class MadLibRandom
{
    public static void main(String[] args)
    {
        ...
        int adver = 0 + (int)(Math.random()* adverbs.length); //adverbs
        ...
        String addyVerbs = adverbs[adver];
        ...
        System.out.printf("\"Don't be such a(n) %s! We're going in. I think it looks "  + addyVerbs + "\n", noun2 );
