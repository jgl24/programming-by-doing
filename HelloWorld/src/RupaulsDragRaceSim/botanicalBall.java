...
public class botanicalBall implements Challenge {
    ...
    public void getWinner(Queen[] remainingQueens) {
        ...
        String botanicalBallWinner;

        for (int i = 0; i < remainingQueens.length; i++) {
            if (!remainingQueens[i].getIsEliminated()) {

                double queenScore = getBotanicalBallScore(remainingQueens[i]);
        ...
        for (int i = 0; i < remainingQueens.length; i++) {
            if (highestScore == getBotanicalBallScore(remainingQueens[i])) {
                botanicalBallWinner = remainingQueens[i].getDragName();
                System.out.println();
                System.out.println("The Botanical Ball winner(s): " + botanicalBallWinner);
    ...
    public double getBotanicalBallScore(Queen ex) {
