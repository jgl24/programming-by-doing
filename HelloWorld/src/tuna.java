    ...
    public static void main(String[] args) {
        ...
        if (upORkitchen.equals("kitchen")) {
            ...
            if (fridgeORcab.equals("refrigerator")) {
                ...
                if (yORn.equals("yes")) {
                    System.out.println("The food was poisoned... you dead bitch ");   /// ending 1
                ...
                if (yesOno.equals("yes")) {
                    System.out.println("You open the door and... out pops Megan Thee Stallion. You tell her you're hungry, to which she replies \" you hungry? well my pussy the kitchen\" " +
